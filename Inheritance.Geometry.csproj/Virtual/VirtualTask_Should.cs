...
namespace Inheritance.Geometry.Virtual
{
    ...
    public class VirtualTask_Should
    {
        ...
        public void CompoundBody_Of_TwoCuboids_BoundingBox_Correct(double x0, double y0, double z0, double x1, double y1, double z1, 
                                                                   double expectedSizeX, double expectedSizeY, double expectedSizeZ)
        {
